...
def test_graph():
    ...
    for w in [False, True]:
        ...
        for ww in [False, True]:
            ...
            assert_equal(list(g.neighbor_coverage_of(weights=ww)), [(1, 0.0625), (2, 0.0625), (3, 0.0625)])
            assert_equal(list(g.neighbor_coverage_of(direction='both', weights=ww)), [(1, 0.125), (2, 0.125), (3, 0.125)])
