...
pip install --upgrade pandas matplotlib setuptools nose coverage sphinx pillow sphinx-gallery sphinx_rtd_theme sphinxcontrib-bibtex nb2plots numpydoc tqdm ccfi cairosvg > /dev/null
