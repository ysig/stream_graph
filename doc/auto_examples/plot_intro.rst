.. note::
    ...
    Click :ref:`here <sphx_glr_download_auto_examples_plot_intro.py>` to download the full example code
.. rst-class:: sphx-glr-example-title

.. _sphx_glr_auto_examples_plot_intro.py:
...
.. _sphx_glr_download_auto_examples_plot_intro.py:
...
.. only :: html
 ...
 .. container:: sphx-glr-footer
  ...
  .. container:: sphx-glr-download
     ...
     :download:`Download Python source code: plot_intro.py <plot_intro.py>`



  .. container:: sphx-glr-download

     :download:`Download Jupyter notebook: plot_intro.ipynb <plot_intro.ipynb>`
