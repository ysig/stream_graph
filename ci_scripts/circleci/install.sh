...
pip install --upgrade pandas matplotlib setuptools sphinx sphinx-gallery sphinx_rtd_theme sphinxcontrib-bibtex nbsphinx nb2plots numpydoc pillow cairosvg > /dev/null
pip install cffi
